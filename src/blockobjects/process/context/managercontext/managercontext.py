...
from ..contextualobjects import ContextualLock, ContextualEvent, ContextualQueue, ContextualSimpleQueue, ContextualProxy
...
class ManagerContext(BaseProcessingContext):
    ...
    def create_lock(self, name=None, *args, cls=None, **kwargs) -> LockInterface:
        """Creates and adds a lock to the context's context.
    ...
    def create_event(self, name=None, *args, cls=None, **kwargs) -> EventInterface:
        """Creates and adds an event to the context's context.
    ...
    def create_queue(self, name=None, *args, cls=None, **kwargs) -> QueueInterface:
        """Creates and adds a queue to the context's context.
    ...
    def create_simple_queue(self, name=None, *args, cls=None, **kwargs) -> QueueInterface:
        """Creates and adds a simple queue to the context's context.
